...
2. **결과 평가**: 어떤 자료가 있는지, 연도 확인
3. **구체화**: "[티커] 10-K 2024 site:sec.gov"
4. **Earnings Call**: "[기업명] earnings call transcript Q[N] 2024"
5. **링크 추적**: 유용한 인용 발견 시 원본 따라가기 (최대 3-depth)

**하지 말 것**: 처음부터 "Item 1A Risk Factors semiconductor shortage" 같은 구체적 검색
...
### 필수 항목 기반
- 10-K 핵심 3개 섹션 (Business, Risk Factors, MD&A) 확보 → 해당 항목 완료
- Earnings Call 2개 확보 → 해당 항목 완료

### 1차 자료 우선
- SEC EDGAR에서 10-K 확보 → 추가 검색 불필요
- 공식 transcript 확보 → 추가 검색 불필요
...
### 링크 depth 제한
- 유용한 소스의 인용 따라가기 **최대 3-depth**
- 각 depth에서 핵심 정보 기록 후 복귀
